...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2019 at 11:45 AM
...
INSERT INTO `categories` (`id`, `category_name`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 'Hunyvwvhhhyuua', 'C000', '2019-05-16 10:57:05', '2019-05-16 10:57:05'),
(2, 'T papuDumana', 'C000', '2019-05-16 10:57:08', '2019-05-16 10:57:08'),
(3, 'Hgitpunr t', 'C000', '2019-05-16 10:57:11', '2019-05-16 10:57:11');
...
INSERT INTO `companies` (`id`, `Company_name`, `Company_logo`, `Company_id`, `Company_phone`, `Company_address`, `plan`, `expired`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Nayem ltd', '411558025537.jpg', 'C000', NULL, NULL, 1, NULL, 1, '2019-05-16 10:52:17', '2019-05-16 10:52:17');
...
CREATE TABLE `customers` (
  ...
  `company_logo` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_employ` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accountant_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accountant_address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `accountant_phone` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `director_dob` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `director_address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Company_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `expance_lists`
--

CREATE TABLE `expance_lists` (
  `id` int(10) UNSIGNED NOT NULL,
  `expenses_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `items` (
  ...
  `item_pic` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `items` (`id`, `category_id`, `subcategory_id`, `item_name`, `item_pic`, `description`, `manufacturer`, `unit_id`, `status`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, '1', '4', '\' ekro aul', '631558025979.jpg', 'Ja umoja neeznek iti va ko ka cu cupek otebebeg silaguseg desotve cevdo ikig pug ebo cavbo. Vedaj kihuowe emo moateec ekogi tijsa pep mojefe ola con nov duuwira newive caz ahuzo fezfocgi fefcu obugijuz. Mokitrin sojtop kireh jub vapror am atsit bucmok cozle dop ha omkic mezm', 'Lat mw g', '1', 0, 'C000', '2019-05-16 10:59:39', '2019-05-16 10:59:39'),
(2, '1', '7', 'Iiagha', '341558026019.jpg', 'Vu ime jate fehki mifowini tik az izpazti vomnub kidja fulo bufkuf. Weweka tulombof kuju oju amalot zoibi ebeju vamgefe fusiwzob guconso luz zonfo al meh. Macpoog ok piglikse fe te ma tujena jejfem lebaozi ejuwep ju evtoj supsutig ragogtid eh hujuhi fa. El egu gewdoda', 'Nbtg lslbfta', '1', 0, 'C000', '2019-05-16 11:00:19', '2019-05-16 11:00:19'),
(3, '2', '1', '\'h', '751558026066.jpg', 'Uca ci vorifgej imsa toluhpih jil kigfudub ekohizi se ten voz ocujier sale up em girardep vopepkam. Vokeug rasawe doso nelej lefzi zejhukeg sibmemlav suesuca gigjino ivlik losaag mujop. Po mu lovuca zudkicmaf gavdu fon dokijimoz tonlalwu aznaase kuoti zelso sazu olu. Gano gi osiviz udajugjup gucke ogv', 'Rnbntnnoueh ah', '2', 0, 'C000', '2019-05-16 11:01:06', '2019-05-16 11:01:06');
...
(2, '2019_02_17_013045_create_companies_table', 1),
(3, '2019_02_18_132218_create_categories_table', 1),
(4, '2019_02_19_054410_create_subcategories_table', 1),
(5, '2019_02_19_114242_create_items_table', 1),
(6, '2019_02_21_151302_create_product_prices_table', 1),
(7, '2019_02_22_140055_create_suppliers_table', 1),
(8, '2019_02_23_080350_create_customers_table', 1),
(9, '2019_02_23_101212_create_units_table', 1),
(10, '2019_03_02_052838_setup_countries_table', 1),
(11, '2019_03_02_052840_charify_countries_table', 1),
(12, '2019_03_17_132520_create_expances_table', 1),
(13, '2019_03_17_152926_create_expance_lists_table', 1),
(14, '2019_03_24_143002_create_warehouses_table', 1),
(15, '2019_04_22_094910_create_purchases_table', 1),
(16, '2019_04_22_095123_create_purchase_products_table', 1),
(17, '2019_04_22_095208_create_warehouse_products_table', 1);
...
INSERT INTO `product_prices` (`id`, `country_id`, `item_id`, `price`, `vat`, `tax`, `discount`, `ait`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, '4', '1', 40, 3, 3, 10, 3, 'C000', '2019-05-16 11:02:28', '2019-05-16 11:02:28'),
(2, '4', '2', 40, 3, 30, 20, 74, 'C000', '2019-05-16 11:02:44', '2019-05-16 11:02:44');
...
CREATE TABLE `purchases` (
  ...
  `warehouse_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `subtotal` int(11) NOT NULL,
  `freight` int(11) DEFAULT NULL,
  `total` int(11) NOT NULL,
  `remarks` varchar(999) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `Company_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `purchases` (`id`, `requisition_no`, `date`, `order_no`, `invoice_no`, `supplier_id`, `warehouse_no`, `country_no`, `subtotal`, `freight`, `total`, `remarks`, `status`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 'PRC000978000', '05/17/2019', NULL, '', '1', '1', '4', 113, 100, 213, NULL, 0, 'C000', '2019-05-16 22:23:15', '2019-06-17 05:58:40'),
(2, NULL, '06/18/2019', 'POC000337001', 'PIC000648002', '1', '1', '4', 113, 10, 123, 'dcBXZSCX', 2, 'C000', '2019-06-18 11:03:41', '2019-06-18 12:05:27');
...
INSERT INTO `purchase_products` (`id`, `purchase_id`, `product_code`, `product_id`, `price`, `quantity`, `vat`, `tax`, `discount`, `ait`, `total_amount`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, '1', 40, 1, 3, 3, 10, 3, 39, 'C000', '2019-05-16 22:23:15', '2019-05-16 22:23:15'),
(2, 1, NULL, '2', 40, 1, 3, 30, 20, 74, 74, 'C000', '2019-05-16 22:23:15', '2019-05-16 22:23:15'),
(3, 2, NULL, '1', 40, 1, 3, 3, 10, 3, 39, 'C000', '2019-06-18 11:03:41', '2019-06-18 11:03:41'),
(4, 2, NULL, '2', 40, 1, 3, 30, 20, 74, 74, 'C000', '2019-06-18 11:03:41', '2019-06-18 11:03:41');
...
INSERT INTO `subcategories` (`id`, `category_id`, `subcategory_name`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, '2', 'Apnm onaaa', 'C000', '2019-05-16 10:57:55', '2019-05-16 10:57:55'),
(2, '3', 'N aeaattn', 'C000', '2019-05-16 10:57:58', '2019-05-16 10:57:58'),
(3, '3', 'Aut be hbaner', 'C000', '2019-05-16 10:58:01', '2019-05-16 10:58:01'),
(4, '1', 'Hl ak', 'C000', '2019-05-16 10:58:03', '2019-05-16 10:58:03'),
(5, '2', 'TiKhta', 'C000', '2019-05-16 10:58:05', '2019-05-16 10:58:05'),
(6, '3', 'Um', 'C000', '2019-05-16 10:58:07', '2019-05-16 10:58:07'),
(7, '1', 'Aoapmat aa be', 'C000', '2019-05-16 10:58:10', '2019-05-16 10:58:10'),
(8, '3', 'HOal', 'C000', '2019-05-16 10:58:13', '2019-05-16 10:58:13'),
(9, '1', 'Ugaugl lanwoa', 'C000', '2019-05-16 10:58:35', '2019-05-16 10:58:35'),
(10, '3', 'Hgnh', 'C000', '2019-05-16 10:58:37', '2019-05-16 10:58:37'),
(11, '3', 'UebogtalOu\'', 'C000', '2019-05-16 10:58:40', '2019-05-16 10:58:40');
...
INSERT INTO `suppliers` (`id`, `supplier_id`, `company_name`, `company_phone`, `company_location`, `company_email`, `company_reg_no`, `company_logo`, `total_employ`, `accountant_name`, `accountant_address`, `accountant_phone`, `bank_name`, `bank_address`, `account_no`, `director_name`, `director_dob`, `director_address`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 'SC000424000', 'Hognraaghal\'an', '8027096413', 'AhOaag pyKam  a', 'vo@rabij.wf', '86', '511558026243.jpg', 'vo@rabij.wf', 'Aigmp gttnt', 'I', '3469925587', 'Ahyh b', 'Vs', 'Ar  kh', 'Htaenamilea', 'Abaho n', 'Alnta h afaa', 'C000', '2019-05-16 11:04:03', '2019-05-16 11:04:03'),
(2, 'SC000622001', 'Ub', '8556796424', 'T', 'dicilana@feh.cl', '373', '991558026257.jpg', 'dicilana@feh.cl', 'La', 'ThiaDrualh', '4455414631', 'Cpbgkg', 'Nrgamb\'t o  O a', 'L aamhanphUip', 'Lkpenha blt', 'AhKniggeaia e', 'Nnaunfyhmlt', 'C000', '2019-05-16 11:04:17', '2019-05-16 11:04:17');
...
(1, 'NAmak gn', 'C000', '2019-05-16 10:59:02', '2019-05-16 10:59:02'),
(2, 'Ohgonaban', 'C000', '2019-05-16 10:59:06', '2019-05-16 10:59:06'),
(3, 'L f', 'C000', '2019-05-16 10:59:10', '2019-05-16 10:59:10');
...
INSERT INTO `users` (`id`, `name`, `email`, `user_id`, `password`, `role`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 'Nayem', 'admin@me.com', 'UC000000', '$2y$10$7/vdpe3L0OC5VgSBkJfMYubOWBHF2oJPUWeQ/WCZcSlIeIAPPosQy', NULL, 'C000', '2019-05-16 10:52:17', '2019-05-16 10:52:17');
...
CREATE TABLE `warehouses` (
  ...
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(9999) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Company_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `warehouses` (`id`, `warehouse_id`, `name`, `phone`, `email`, `address`, `country_id`, `Company_id`, `created_at`, `updated_at`) VALUES
(1, 'WC000840000', 'Yn st', '5178389013', 've@zul.pk', 'Ciivpa bantod nuema buk gadhosfe vew zov tu ma ni low zajucwek feh im willo. Ceojode uwa hoan ni fi tosadej omezot kok bode ibofuhis malla nig uva guk asmu ril. Isu of di et cu tekoco edoti wulazpo wazma aji setfappu ewjariw ta gendo', '4', 'C000', '2019-05-16 11:07:55', '2019-05-16 11:07:55'),
(2, 'WC000273001', 'A lfp eg', '2772457426', 'ita@wiwin.ki', 'Videwhov linbenab lofa zured jifne ja adpe zi vu norjos miv nobowi zuseta zev efentum huwavsi cirudge aw. Ir jutboplu bere rasios ciwme wid awe seje zu cuihawep med sa bosuej ugizowin. Uv vobulbe kob cec idw', '4', 'C000', '2019-05-16 11:08:00', '2019-05-16 11:08:00');
...
--
-- Indexes for table `expance_lists`
--
ALTER TABLE `expance_lists`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `expance_lists`
--
ALTER TABLE `expance_lists`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
