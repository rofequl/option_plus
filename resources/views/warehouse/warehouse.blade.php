            ...
            <div class="collapse my-4" id="collapseExample">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-inline">
                            <div class="form-group mx-sm-3 mb-2" style="width: 54%">
                                <label for="inputCategory" class="sr-only"></label>
                                <textarea placeholder="Enter Warehouse Address" class="form-control w-100" id="WarehouseAddress" rows="3"></textarea>
                            </div>
            ...
            $(document).on('click', '.addWarehouse', function () {
                ...
                if (name != '' && phone != '' && email != '' && address != '') {
                    $.ajax({
                        url: 'add-warehouses',
                        type: 'post',
                        data: {_token: CSRF_TOKEN, name: name, phone: phone, email: email, address: address},
            ...
            $(document).on('click', '.UpdateWarehouse', function () {
                ...
                if (name != '' && phone != '' && email != '' && address != '') {
                    $.ajax({
                        ...
                        type: 'post',
                        data: {_token: CSRF_TOKEN, name: name, phone: phone, email: email, address: address, id: id},
                        success: function (data) {
                            if (data == 1) {
                                const Toast = Swal.mixin({
                                    toast: true,
