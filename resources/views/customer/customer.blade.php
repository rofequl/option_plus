...
@section('content')
    ...
    <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
            ...
            <div class="collapse animated  my-4" id="collapseExample">
                <div class="card">
                    <div class="card-header border-bottom inputheader">Add New Customer</div>
                    <div class="card-body">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="name" id="firstName" placeholder="Enter Customer Name">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea style="min-height: 108px;" id="userBio" name="userBio" class="form-control" placeholder="Customer Information"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col">
                    <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                            <button class="btn btn-primary float-right add"><i class="fa-1x fas fa-plus"></i> Add Customer
                            </button>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.add', function () {
                ...
                $('.collapse').collapse('show').addClass('zoomInDown');
            });
            $(document).on('click', '.closer', function () {
                $('.collapse').collapse('hide').removeClass('zoomInDown').addClass('zoomInUp');
            });
